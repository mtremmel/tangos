...
class ChangaBHImporter(GenericTangosTool):
    ...
    def _get_bh_halo_assignments(self, pynbody_snapshot, pynbody_halos):
        ...
        if 'hostHalo' in pynbody_halos.get_dummy_halo(pynbody_halos._properties['ID'][0]).properties:
            ...
            while continue_searching:
                ...
                min_halo_id = pynbody_halos._properties['ID'].min()
                bh_halos_new = [pynbody_halos.get_dummy_halo(i).properties['hostHalo'] if i>=min_halo_id else -1 for i in bh_halos]
